...
public class MessagePayloadDTO {
    ...
    private List<MessagePayloadLogDTO> logs;

    public static class MessagePayloadLogDTO {
        @JsonFormat(pattern = "yyyy - MM - dd HH:mm:ss")
        private LocalDateTime timestamp;
        private String level;
        private String message;
        // Constructors
        public MessagePayloadLogDTO() {}

        public MessagePayloadLogDTO(LocalDateTime timestamp, String level, String message) {
    ...
    public List<MessagePayloadLogDTO> getLogs() { return logs; }
    public void setLogs(List<MessagePayloadLogDTO> logs) { this.logs = logs; }
}
