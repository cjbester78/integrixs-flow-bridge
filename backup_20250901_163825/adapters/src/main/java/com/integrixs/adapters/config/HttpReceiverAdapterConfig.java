 ...
 */
public class HttpReceiverAdapterConfig {
    ...
    // Constructors
    public HttpReceiverAdapterConfig() {}
    ...
    public String toString() {
        return String.format("HttpReceiverAdapterConfig{targetUrl='%s', method='%s', contentType='%s', auth='%s', proxy='%s'}",
