 ...
 */
@Slf4j
public class MailReceiverAdapter extends AbstractAdapter implements ReceiverAdapterPort {
    ...
    protected AdapterOperationResult performInitialization() {
        log.info("Initializing Mail receiver adapter (outbound) with server: {}:{}",
        ...
        log.info("Mail receiver adapter initialized successfully");
        return AdapterOperationResult.success("Mail receiver adapter initialized");
    }
    
    @Override
    protected AdapterOperationResult performShutdown() {
        log.info("Destroying Mail receiver adapter");
        ...
        batchBuffer.clear();
        mailSession = null;
        return AdapterOperationResult.success("Mail receiver adapter destroyed");
    }
    ...
    private AdapterOperationResult sendEmailMessage(Object payload, boolean isBatch, int itemCount) throws Exception {
        ...
        try {
            ...
            log.info("Mail receiver adapter sent email to {} recipients", recipientCount);
    ...
    public AdapterMetadata getMetadata() {
        return AdapterMetadata.builder()
                ...
                .description("Mail receiver adapter - sends emails to mail servers")
                .version("1.0.0")
