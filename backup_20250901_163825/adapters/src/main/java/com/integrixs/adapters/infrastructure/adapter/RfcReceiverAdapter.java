...
import java.util.HashMap;import java.util.List;import com.integrixs.adapters.config.RfcReceiverAdapterConfig;
 ...
 */
@Slf4j
public class RfcReceiverAdapter extends AbstractAdapter implements ReceiverAdapterPort {
    ...
    protected AdapterOperationResult performInitialization() {
        log.info("Initializing RFC receiver adapter (outbound) for system: {}", config.getSystemId());
    ...
    private AdapterOperationResult executeRfcCall(Object payload) throws Exception {
        ...
        log.info("RFC receiver adapter executed function: {}", responseData.get("functionName"));
