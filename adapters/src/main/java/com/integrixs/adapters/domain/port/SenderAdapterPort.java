...
/**
 * Domain port interface for sender adapters (receive FROM external systems)
 * Note: Following the reversed middleware terminology used in this project
 */
public interface SenderAdapterPort extends AdapterPort {
