 ...
 */
public class SoapInboundAdapterConfig {
    ...
    // Constructors
    public SoapInboundAdapterConfig() {}
    ...
    public String toString() {
        return String.format("SoapInboundAdapterConfig {endpoint = '%s', operation = '%s', auth = '%s', polling = %dms}",
