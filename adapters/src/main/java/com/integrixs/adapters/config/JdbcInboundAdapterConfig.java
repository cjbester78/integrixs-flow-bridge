 ...
 */
public class JdbcInboundAdapterConfig {
    ...
    public JdbcInboundAdapterConfig() {
        ...
        xmlMappingConfig.setRootElementName("records");
        xmlMappingConfig.setRowElementName("record");
        xmlMappingConfig.setIncludeXmlDeclaration(true);
        xmlMappingConfig.setPrettyPrint(true);
    }
    ...
    public String toString() {
        return String.format("JdbcInboundAdapterConfig {url = '%s', driver = '%s', user = '%s', polling = %dms, incremental = '%s'}",
