 ...
 */
public class OdataOutboundAdapterConfig {
    ...
    // Constructors
    public OdataOutboundAdapterConfig() {}
    
    public OdataOutboundAdapterConfig(String configParam) {
    ...
    public String toString() {
        return String.format("OdataOutboundAdapterConfig{targetEndpoint='%s', entitySet='%s', operation='%s', auth='%s'}",
