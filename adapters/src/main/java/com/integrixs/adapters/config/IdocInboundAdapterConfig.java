 ...
 */
public class IdocInboundAdapterConfig {
    ...
    // Constructors
    public IdocInboundAdapterConfig() {}
    
    public IdocInboundAdapterConfig(String configParam) {
    ...
    public String toString() {
        return String.format("IdocInboundAdapterConfig{sourceSystem='%s', idocType='%s', messageType='%s', polling=%dms}",
