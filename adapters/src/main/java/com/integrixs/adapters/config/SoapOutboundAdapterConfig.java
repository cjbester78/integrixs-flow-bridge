 ...
 */
public class SoapOutboundAdapterConfig {
    ...
    // Constructors
    public SoapOutboundAdapterConfig() {}
    ...
    public String toString() {
        return String.format("SoapOutboundAdapterConfig {endpoint = '%s', operation = '%s', auth = '%s', batching = %s}",
