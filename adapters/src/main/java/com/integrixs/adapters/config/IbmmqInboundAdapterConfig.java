...
/**
 * Configuration for IBM MQ Inbound Adapter.
 * In middleware terminology, inbound adapters receive data FROM external source systems.
 * This configuration focuses on consuming messages from IBM MQ queues/topics.
 * Supports IBM MQ(formerly WebSphere MQ) specific features like queue managers, channels, and transport types.
 */
public class IbmmqInboundAdapterConfig {
    ...
    public String getClientId() { return "IbmmqInbound-" + System.currentTimeMillis(); }
    ...
    public String toString() {
        return String.format("IbmmqInboundAdapterConfig {host = '%s:%d', queueManager = '%s', sourceQueue = '%s', transport = '%s'}",
