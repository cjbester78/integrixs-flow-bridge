...
public class FileInboundAdapterConfig {
    ...
    public FileInboundAdapterConfig() {
        ...
        xmlMappingConfig.setRootElementName("fileContent");
        xmlMappingConfig.setRowElementName("row");
    ...
    public String toString() {
        return String.format("FileInboundAdapterConfig {sourceDir = '%s', pattern = '%s', polling = %dms, processing = '%s'}",
