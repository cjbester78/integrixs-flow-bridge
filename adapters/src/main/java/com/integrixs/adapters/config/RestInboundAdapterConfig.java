 ...
 */
public class RestInboundAdapterConfig {
    ...
    public RestInboundAdapterConfig() {
        ...
        jsonXmlWrapperConfig.setRootElementName("restApiResponse");
    ...
    public String toString() {
        return String.format("RestInboundAdapterConfig {endpoint = '%s', method = %s, auth = %s, polling = %dms, pageSize = %s}",
