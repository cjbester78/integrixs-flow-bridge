 ...
 */
public class JmsInboundAdapterConfig {
    ...
    // Constructors
    public JmsInboundAdapterConfig() {}
    
    public JmsInboundAdapterConfig(String configParam) {
    ...
    public String toString() {
        return String.format("JmsInboundAdapterConfig{host='%s:%d', queueManager='%s', sourceQueue='%s', transport='%s'}",
