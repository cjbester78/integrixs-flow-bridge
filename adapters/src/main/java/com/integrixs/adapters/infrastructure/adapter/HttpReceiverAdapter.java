 ...
 */
@Slf4j
public class HttpReceiverAdapter extends AbstractAdapter implements ReceiverAdapterPort {
    ...
    protected AdapterOperationResult performInitialization() {
        log.info("Initializing HTTP receiver adapter (outbound) with endpoint: {}", 
        ...
        try {
            ...
            log.info("HTTP receiver adapter initialized successfully");
    ...
    protected AdapterOperationResult performShutdown() {
        log.info("Destroying HTTP receiver adapter");
    ...
    public AdapterMetadata getMetadata() {
        return AdapterMetadata.builder()
                ...
                .description("HTTP Receiver adapter implementation")
                .version("1.0.0")
                .supportsBatch(true)
                .supportsAsync(true)
                .build();
