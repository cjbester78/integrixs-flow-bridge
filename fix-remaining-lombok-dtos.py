#!/usr/bin/env python3
"""
Fix the remaining Lombok DTOs with nested classes manually
"""

# First, let's fix FlowExportDTO which has nested classes
flow_export_content = '''package com.integrixs.shared.dto.export;

import com.integrixs.shared.dto.FlowDTO;
import com.integrixs.shared.dto.business.BusinessComponentDTO;
import com.integrixs.shared.dto.adapter.CommunicationAdapterDTO;
...
# Write the fixed DTOs
import os

with open('/Users/cjbester/git/Integrixs-Flow-Bridge/shared-lib/src/main/java/com/integrixs/shared/dto/export/FlowExportDTO.java', 'w') as f:
    f.write(flow_export_content)

print("Fixed FlowExportDTO")