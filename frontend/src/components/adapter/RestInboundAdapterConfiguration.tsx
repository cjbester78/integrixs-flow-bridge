...
interface RestInboundAdapterConfigurationProps {
 configuration: any;
 onConfigurationChange: (field: string, value: string | number | TransformationConfig | PayloadStructureConfig | any) => void
}

export function RestInboundAdapterConfiguration({
 configuration,
 onConfigurationChange
}: RestInboundAdapterConfigurationProps) {
 ...
 <Card>
 <CardHeader>
 <CardTitle>REST Inbound Configuration</CardTitle>
