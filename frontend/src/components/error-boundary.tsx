...
export class ErrorBoundary extends Component<Props, State> {
 ...
 public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    logger.error(LogCategory.UI, 'ErrorBoundary caught an error', { data: error, extra: errorInfo });
 this.setState({
 error,
 errorInfo,
 });
...
export const AsyncErrorBoundary: React.FC<Props> = ({ children, ...props }) => {
 ...
 const handleUnhandledRejection = (event: PromiseRejectionEvent) => {
      logger.error(LogCategory.UI, 'Unhandled promise rejection', { error: event.reason });
