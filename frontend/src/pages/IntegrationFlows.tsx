...
import { useIntegrationFlowMonitoring } from '@/hooks/useIntegrationFlowMonitoring';
import { BusinessComponent } from '@/types/businessComponent';
import { MessageSquare, RefreshCw, Wifi, WifiOff } from 'lucide-react';
import { IntegrationFlowStats } from '@/components/integration-flows/IntegrationFlowStats';
import { IntegrationFlowList } from '@/components/integration-flows/IntegrationFlowList';
...
export const IntegrationFlows = () => {
 useDocumentTitle('Integration Flow Monitor');
 useMetaDescription('Track and monitor all integration flow executions, view processing status, and analyze integration flows through your Integrix Flow Bridge system.');
 ...
 refreshData,
 loadStats
 } = useIntegrationFlowMonitoring(selectedBusinessComponent?.id);
 ...
 <PageContainer>
 <PageHeader
 title="Integration Flow Monitor"
 description="Track and analyze integration flow executions"
 icon={<MessageSquare />}
 actions={
