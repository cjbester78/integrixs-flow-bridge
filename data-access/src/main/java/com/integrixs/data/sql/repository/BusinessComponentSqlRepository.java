 ...
 * Handles bidirectional @OneToMany relationships with CommunicationAdapter and IntegrationFlow.
 */
...
public class BusinessComponentSqlRepository extends BaseSqlRepository<BusinessComponent, UUID> {
    ...
    public Optional<BusinessComponent> findById(UUID id) {
        ...
        // Note: @OneToMany collections are not loaded by default to avoid N+1 problems
